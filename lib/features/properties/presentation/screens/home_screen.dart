...
class _HomeScreenContentState extends State<HomeScreenContent> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      provider.loadFeaturedProperties();
      provider.loadPropertiesByType(_selectedCategory);
    });
  }
  ...
  void _onCategoryChanged(String category) {
    ...
    context.read<PropertyProvider>().loadPropertiesByType(category);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final recommendedProperties = propertyProvider.properties;
