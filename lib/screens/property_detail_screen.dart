                          ...
                          return Image.asset(
                            ...
                            errorBuilder: (context, error, stackTrace) {
                              return Container(
                                ...
                                child: const Center(
                                  child: Icon(Icons.home, size: 80, color: AppColors.textSecondary),
                                ),
                              );
                            },
                          );
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // About This Space
                      const Text('About this space', style: AppTextStyles.heading3),
                      const SizedBox(height: AppSpacing.md),
                      Text(
                      ...
                      Row(
                        ...
                        children: [
                          const Text('What this place offers', style: AppTextStyles.heading3),
                          TextButton(
                            onPressed: () {},
                            child: const Text(
                              'See All',
